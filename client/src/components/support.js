        ...
        <section className="bg-white dark:bg-black sm:py-8 lg:py-10">
            <div className="px-4 mx-auto max-w-6xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">Make every step user-centric</h2>
                    <p className="mt-1 text-base leading-7 text-gray-600 dark:text-gray-400 sm:mt-8 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit</p>
                </div>

                <div className="grid grid-cols-1 mt-1 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                    <div className="md:p-8 lg:p-14">
                        <svg className="mx-auto" width="26" height="26" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 dark:text-white font-pj">Support</h3>
                        <p className="mt-5 text-base text-gray-600 dark:text-gray-400 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 dark:md:border-gray-800">
                        <svg className="mx-auto" width="26" height="26" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 dark:text-white font-pj">Sales</h3>
                        <p className="mt-5 text-base text-gray-600 dark:text-gray-400 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 dark:md:border-gray-800">
                        <svg className="mx-auto" width="26" height="26" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 dark:text-white font-pj">Onboarding</h3>
                        <p className="mt-5 text-base text-gray-600 dark:text-gray-400 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200 dark:md:border-gray-800">
                        <svg className="mx-auto" width="26" height="26" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 dark:text-white font-pj">Product</h3>
                        <p className="mt-5 text-base text-gray-600 dark:text-gray-400 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t dark:md:border-gray-800">
                        <svg className="mx-auto" width="26" height="26" viewBox="0 0 46 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 dark:text-white font-pj">Quality</h3>
                        <p className="mt-5 text-base text-gray-600 dark:text-gray-400 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t dark:md:border-gray-800">
                        <svg className="mx-auto" width="26" height="26" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-gray-900 dark:text-white font-pj">Result</h3>
                        <p className="mt-5 text-base text-gray-600 dark:text-gray-400 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
                    </div>
                </div>
            </div>
