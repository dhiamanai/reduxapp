            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
                {value.map((product) => (
                    <a key={product.id} href={product.href} className="group">
                        <Card className="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transform transition duration-300 hover:scale-105">
                            ...
                            <div className="p-4 space-y-2">
                                ...
                                <Button
                                    className="bg-emerald-500 text-white hover:bg-emerald-600 focus:ring-4 focus:ring-emerald-300 dark:focus:ring-emerald-900 w-full py-2 rounded-md flex items-center justify-center space-x-2 text-sm"
